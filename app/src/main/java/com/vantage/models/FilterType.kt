...
enum class FilterType(val displayName: String, val category: String) {
    ...
    ANIME("Anime", "Fun"),
    SKETCH("Sketch", "Fun"),
    COMIC_BOOK("Comic Book", "Fun"),
    OIL_PAINTING("Oil Painting", "Fun"),
    CYBERPUNK("Cyberpunk", "Fun"),
    UNDERWATER("Underwater", "Fun"),
    MARS("Mars", "Fun"),
    AURORA("Aurora", "Fun"),
    RADIOACTIVE("Radioactive", "Fun");
    ...
    companion object {
        ...
        private val keywordMap = mapOf(
            ...
            "DRAWN" to SKETCH,
            "COMIC" to COMIC_BOOK,
            "SUPERHERO" to COMIC_BOOK,
            "GRAPHIC" to COMIC_BOOK,
            "OIL" to OIL_PAINTING,
            "PAINTING" to OIL_PAINTING,
            "PAINT" to OIL_PAINTING,
            "ARTISTIC" to OIL_PAINTING,
            "CYBER" to CYBERPUNK,
            "CYBERPUNK" to CYBERPUNK,
            "PUNK" to CYBERPUNK,
            "FUTURISTIC" to CYBERPUNK,
            "UNDERWATER" to UNDERWATER,
            "AQUA" to UNDERWATER,
            "DEEP" to UNDERWATER,
            "SUBMERGED" to UNDERWATER,
            "MARS" to MARS,
            "MARTIAN" to MARS,
            "RED_PLANET" to MARS,
            "ALIEN" to MARS,
            ...
            "TOXIC" to RADIOACTIVE,
            "NUCLEAR" to RADIOACTIVE,
            "ACID" to RADIOACTIVE,
            "GLOWING" to RADIOACTIVE,
        )
