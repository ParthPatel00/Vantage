...
class GemmaEngine {
    ...
    private fun buildRound1Prompt(userIntent: String? = null): String {
        val intentLine = if (!userIntent.isNullOrBlank()) "USER WANTS: \"$userIntent\". Match this mood.\n" else ""
        return """
...
{"filter":"KODAK_GOLD","iso":200,"shutter":125,"wb":"daylight","brightness":0.04,"contrast":1.20,"saturation":1.15,"gamma":1.08,"reason":"short"}
""".trimIndent()
    }
...
{"filter":"${prev.filter.name}","iso":200,"shutter":125,"wb":"daylight","brightness":0.0,"contrast":1.2,"saturation":1.1,"gamma":1.1,"ready":true,"reason":"short"}
""".trimIndent()
    }
